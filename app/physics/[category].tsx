...
import { ArrowLeft, Send, Atom } from 'lucide-react-native';

export default function PhysicsCategoryInput() {
  ...
  const categoryTips = {
    mechanics: "Include mass, velocity, and force values if applicable",
    thermodynamics: "Specify initial and final temperatures, pressure values",
    electromagnetism: "Include charge values, distances, and field strengths",
    optics: "Specify wavelengths, distances, and angles",
    quantum: "Include energy levels and quantum numbers if applicable"
  };
    ...
    <View style={[styles.container, { backgroundColor: isDarkMode ? '#000000' : '#F2F2F7' }]}>
      <View style={[styles.header, { backgroundColor: isDarkMode ? '#1C1C1E' : '#FFFFFF' }]}>
        ...
        <Text style={[styles.headerTitle, { color: isDarkMode ? '#FFFFFF' : '#000000' }]}>
          {category ? category.charAt(0).toUpperCase() + category.slice(1) : 'Physics'} Problem
        </Text>
      </View>
      ...
      <ScrollView style={styles.content}>
        <View style={[styles.formCard, { backgroundColor: isDarkMode ? '#1C1C1E' : '#FFFFFF' }]}>
          <View style={styles.categoryHeader}>
            <Atom size={24} color={isDarkMode ? '#FFFFFF' : '#000000'} />
            <Text style={[styles.categoryTitle, { color: isDarkMode ? '#FFFFFF' : '#000000' }]}>
              {category ? category.charAt(0).toUpperCase() + category.slice(1) : 'Physics'} Problem Solver
            </Text>
          </View>
          ...
          <TextInput
            ...
            placeholder="e.g., SI units (meters, kilograms, seconds)"
          ...
          <Text style={[styles.tip, { color: isDarkMode ? '#8E8E93' : '#8E8E93' }]}>
            Tip: {categoryTips[category as keyof typeof categoryTips] || "Include all relevant values and units in your description."}
          </Text>
        </View>
      </ScrollView>
    </View>
