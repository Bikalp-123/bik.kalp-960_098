...
export default function ChemistryProblemInput() {
      ...
      <ScrollView style={styles.content}>
        <View style={[styles.formCard, { backgroundColor: isDarkMode ? '#1C1C1E' : '#FFFFFF' }]}>
          ...
          <TextInput
            ...
            placeholder="e.g., Stoichiometry, Acids & Bases, Thermodynamics"
          ...
          <TextInput
            ...
            placeholder="Type your chemistry problem here..."
            placeholderTextColor={isDarkMode ? '#8E8E93' : '#8E8E93'}
            multiline
          ...
          <Text style={[styles.tip, { color: isDarkMode ? '#8E8E93' : '#8E8E93' }]}>
            Tip: Include balanced chemical equations and concentrations when applicable.
          </Text>
        </View>
      </ScrollView>
    </View>
